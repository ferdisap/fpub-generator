    ...
    <div class="dmStatus">
      ...
      <div>
        <ul>
          ...
          <li>Source DM: <xsl:apply-templates select="sourceDmIdent"/></li>
          <li>Repository DM: <xsl:apply-templates select="repositorySourceDmIdent"/></li>
          ...
          <li>Applicability Document: 
            ...
            <xsl:apply-templates select="applicCrossRefTableRef/descendant::dmRefIdent"/>
          </li>
